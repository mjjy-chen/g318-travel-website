    ...
    switch(type) {
            ...
            itemsHtml = `
                <div class="scenery-grid">
                    <div class="scenery-item">
                        <img src="public/images/scenery/yalasnow.webp" alt="雅拉雪山" class="scenery-img" loading="lazy">
                        <h4>雅拉雪山</h4>
                        <p>海拔7294米，终年雪山，是川藏线最著名的雪山景观之一。最佳观赏时间：4-6月，上午时分云雾较少。</p>
                        <p class="tip">小贴士：可在察瓦龙镇观景台俯瞰全貌，注意防晒和保暖。</p>
                    </div>
                    <div class="scenery-item">
                        <img src="public/images/scenery/ranwu.webp" alt="然乌湖" class="scenery-img" loading="lazy">
                        <h4>然乌湖</h4>
                        <p>被誉为“人间仙湖”，湖水澄澈如镜，倒映着雪山和森林。最佳旅游季节：5-10月。</p>
                        <p class="tip">小贴士：湖边有藏民家访体验，可尝试奶酪和青稞酒。</p>
                    </div>
                    <div class="scenery-item">
                        <img src="public/images/scenery/basumtso.webp" alt="巴松措" class="scenery-img" loading="lazy">
                        <h4>巴松措</h4>
                        <p>“神湖”之美，湖光山色相映成趣，四季景色各异。春季杜鹃花开尤为壮观。</p>
                        <p class="tip">小贴士：环湖步行约2小时，沿途有多个观景点可拍摄倒影。</p>
                    </div>
                    <div class="scenery-item">
                        <img src="public/images/scenery/72hairpin.webp" alt="72拐" class="scenery-img" loading="lazy">
                        <h4>72拐</h4>
                        <p>海拔4000多米的蜿蜒山路，共有72个弯道，是川藏线上最具挑战的路段之一。</p>
                        <p class="tip">小贴士：上坡时使用低挡，下坡时靠边行驶，注意迎车。</p>
                    </div>
                    <div class="scenery-item">
                        <img src="public/images/scenery/midui.webp" alt="米堆冰川" class="scenery-img" loading="lazy">
                        <h4>米堆冰川</h4>
            ...
            itemsHtml = `
                <div class="accommodation-list">
                    <div class="accommodation-item">
                        <img src="public/images/accommodation/hilton.webp" alt="林芝希尔顿逸林酒店" class="accommodation-img" loading="lazy">
                        <h4>林芝希尔顿逸林酒店</h4>
                    ...
                    <div class="accommodation-item">
                        <img src="public/images/accommodation/gesar.webp" alt="波密古乡格萨尔王庄园" class="accommodation-img" loading="lazy">
                        <h4>波密古乡格萨尔王庄园</h4>
                        <p>⭐⭐⭐⭐ | 波密县 | 约¥250-350/晚</p>
        ...
        case 'food':
            ...
            itemsHtml = `
                <div class="food-grid">
                    <div class="food-item">
                        <img src="public/images/food/buttertea.webp" alt="酥油茶" class="food-img" loading="lazy">
                        <h4>酥油茶</h4>
                    ...
                    <div class="food-item">
                        <img src="public/images/food/stonechicken.webp" alt="石锅鸡" class="food-img" loading="lazy">
                        <h4>石锅鸡（巴松措特色）</h4>
            ...
            itemsHtml = `
                <div class="culture-list">
                    <div class="culture-item">
                        <img src="public/images/culture/temple.webp" alt="藏传佛教寺庙" class="culture-img" loading="lazy">
                        <h4>藏传佛教寺庙</h4>
                    ...
                    <div class="culture-item">
                        <img src="public/images/culture/butterflower.webp" alt="酥油花制作" class="culture-img" loading="lazy">
                        <h4>酥油花制作</h4>
